...
const translationEngDefault = {
  SkhemataGdpr: {
    ...
    gdprText: 'This website uses cookies to ensure you get the best experience on our website.',
    gotIt: 'Got it!'
  }
};

class SkhemataGdpr extends SkhemataBase {
  constructor() {
    var _a, _b, _c;
    ...
    let cookie = (_c = (_b = (_a = document.cookie) === null || _a === void 0 ? void 0 : _a.split('; ')) === null || _b === void 0 ? void 0 : _b.find(row => row.startsWith('__skhemata_gdpr_allow_cookies='))) === null || _c === void 0 ? void 0 : _c.split('=')[1]; // Checks if the consent has been clicked before
  ...
  render() {
    let link = this.configData.link ? this.configData.link : false;
    return !this.allowCookies ? T`     
      <div class="cookies-container">
        <p>${this.getStr('SkhemataGdpr.gdprText')} ${link ? T`<a href="${link}" target="_blank">${this.getStr('SkhemataGdpr.learnMore')}</a>` : ''}</p>
...
__decorate([e$3({
  type: Object
})], SkhemataGdpr.prototype, "translationData", void 0);

__decorate([e$3({
  type: Boolean
})], SkhemataGdpr.prototype, "allowCookies", void 0);
